...
int const MAX_CHARS_IN_NAME_LABEL_LIST_MENU = 1120;
int const MAX_CHARS_IN_NAME_LABEL_PHOTO_MENU = 1120;
int const LINE_HEIGHT_IN_NAME_LABEL_LIST_MENU = 21;
int const LINE_HEIGHT_IN_NAME_LABEL_PHOTO_MENU = 26;
